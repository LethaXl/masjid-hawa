        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-orange-50 p-6 rounded-lg border border-gray-200 flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-orange-700">Daily Prayers</h3>
              ...
              <div className="bg-orange-50 p-6 rounded-lg border border-gray-200 flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-orange-700">Quran Classes</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-orange-50 p-6 rounded-lg border border-gray-200 flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-orange-700">Community Events</h3>
                <p className="text-gray-700">
