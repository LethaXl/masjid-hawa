        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <form className="flex flex-col sm:flex-row" suppressHydrationWarning>
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className="bg-green-800 text-white px-4 py-2 mb-2 sm:mb-0 rounded-l"
                  suppressHydrationWarning
                />
                <button 
                  type="submit" 
                  className="bg-green-600 hover:bg-green-500 text-white px-4 py-2 rounded-r"
                  suppressHydrationWarning
                >
                  Subscribe
                </button>
